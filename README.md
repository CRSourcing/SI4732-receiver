...
CW, RTTY, SSTV and WEFAX decoders are included. A web interface is included. A KiwiSDR client lets you select a KiwiSDR and listen to the current frequency.
